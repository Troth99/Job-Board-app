    ...
    <div className="job-details-container">
      <div className="job-overview">
        ...
        <div className="job-description">
          <p>
            ...
            The ideal candidate should have experience with React, JavaScript,
            and CSS.
          </p>
        </div>
        <div className="job-location-salary">
          ...
          <div>
            <strong>Salary:</strong> $80,000 - $100,000 per year
          </div>
        </div>
        <div className="job-category-type">
          <div>
            <strong>Job Category:</strong> IT
          </div>
          <div>
        ...
        <div className="job-skills-benefits">
          ...
          <div>
            <strong>Benefits:</strong> Health Insurance, Remote Work
          </div>
        </div>
      </div>
      ...
      <div className="job-actions">
        ...
        <div className="job-actions-buttons">
          <button className="edit-job-button" onClick={editNavigateHandler}>
            Edit Job
          </button>
