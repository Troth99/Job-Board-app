...
export default function Dashboard() {
  ...
  const { members, localRole, loading, refresh, company } =
    useCompanyMember(companyId);

  const isReadOnly = localRole === "member";
        ...
        <div className="main-content">
          ...
          >
            <p className="dashboard-kicker">
              <Trans>Operational overview</Trans>
            </p>
            <h1 className="dashboard-title">
              <Trans>Company dashboard</Trans>
            </h1>
            <p className="dashboard-subtitle">
              <Trans>
                Streamline team coordination, internal communication, and hiring
                execution from a single control panel.
              </Trans>
            </p>
          </div>
          ...
          >
            <div className="section-heading">
              <h2>
                <Trans>Team tools</Trans>
              </h2>
              <p>
                <Trans>Invite members and send internal messages.</Trans>
              </p>
            </div>
            ...
            <div className="section-heading">
              {isReadOnly ? (
                <div className="dashboard-readonly-notice" role="status">
                  <p>
                    <Trans>
                      You have read-only access to the jobs board. You cannot
                      create, edit, or delete job listings.
                    </Trans>
                  </p>
                  <p>
                    <Trans>
                      Contact an administrator if you need permission to manage
                      job listings.
                    </Trans>
                  </p>
                </div>
                ...
                <>
                  <h2>
                    <Trans>Jobs board control</Trans>
                  </h2>
                  <p>
                    <Trans>
                      Post new jobs and monitor recent openings for your
                      company.
                    </Trans>
                  </p>
                </>
          ...
          <section className="dashboard-panel dashboard-section dashboard-future-section">
            <div className="section-heading">
              <h2>
                <Trans>Future modules</Trans>
              </h2>
              <p>
                <Trans>
                  Add more options here as your company workflow grows.
                </Trans>
              </p>
            </div>
            <div className="future-module-grid">
              <article className="future-module-card">
                ...
                <p>
                  <Trans>
                    Share updates with all company members in one feed.
                  </Trans>
                </p>
              </article>
              <article className="future-module-card">
                ...
                <p>
                  <Trans>
                    Monitor hiring activity and member engagement trends.
                  </Trans>
                </p>
              </article>
            </div>
