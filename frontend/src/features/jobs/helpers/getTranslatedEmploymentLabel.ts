...
export function getTranslatedExperienceLabel(value: string) {
  switch (value) {
    case "No prior experience required":
      return t`No prior experience required`;
    case "Some experience preferred (6+ months)":
      return t`Some experience preferred (6+ months)`;
    case "1+ year relevant experience":
      return t`1+ year relevant experience`;
    case "2+ years relevant experience":
      return t`2+ years relevant experience`;
    case "3+ years relevant experience":
      return t`3+ years relevant experience`;
    case "5+ years relevant experience":
      return t`5+ years relevant experience`;
    case "Supervisory experience required":
      return t`Supervisory experience required`;
    case "Management experience required":
      return t`Management experience required`;
    default:
      return value;
  }
}

export function getTranslatedWorkModeLabel(value: string) {
  switch (value) {
    case "On-site":
      return t`On-site`;
    case "Hybrid":
